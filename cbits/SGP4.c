...
*/
	...
	*    vallado, crawford, hujsak, kelso  2006
	...
	static void dpper
		(
		const double e3, const double ee2, const double peo, const double pgho, const double pho,
		const double pinco, const double plo, const double se2, const double se3, const double sgh2,
		const double sgh3, const double sgh4, const double sh2, const double sh3, const double si2,
		const double si3, const double sl2, const double sl3, const double sl4, const double t,
		const double xgh2, const double xgh3, const double xgh4, const double xh2, const double xh3,
		const double xi2, const double xi3, const double xl2, const double xl3, const double xl4,
		const double zmol, const double zmos, const double inclo __attribute__((unused)),
		const char init,
		double* const ep, double* const inclp, double* const nodep, double* const argpp, double* const mp,
		const char opsmode
		)
	{
		/* --------------------- local variables ------------------------ */
	...
	*    vallado, crawford, hujsak, kelso  2006
	...
	static void dscom
		(
		const double epoch, const double ep, const double argpp, const double tc, const double inclp,
		const double nodep, const double np,
		double* const snodm, double* const cnodm, double* const sinim, double* const cosim, double* const sinomm,
		double* const cosomm, double* const day, double* const e3, double* const ee2, double* const em,
		double* const emsq, double* const gam, double* const peo, double* const pgho, double* const pho,
		double* const pinco, double* const plo, double* const rtemsq, double* const se2, double* const se3,
		double* const sgh2, double* const sgh3, double* const sgh4, double* const sh2, double* const sh3,
		double* const si2, double* const si3, double* const sl2, double* const sl3, double* const sl4,
		double* const s1, double* const s2, double* const s3, double* const s4, double* const s5,
		double* const s6, double* const s7, double* const ss1, double* const ss2, double* const ss3,
		double* const ss4, double* const ss5, double* const ss6, double* const ss7, double* const sz1,
		double* const sz2, double* const sz3, double* const sz11, double* const sz12, double* const sz13,
		double* const sz21, double* const sz22, double* const sz23, double* const sz31, double* const sz32,
		double* const sz33, double* const xgh2, double* const xgh3, double* const xgh4, double* const xh2,
		double* const xh3, double* const xi2, double* const xi3, double* const xl2, double* const xl3,
		double* const xl4, double* const nm, double* const z1, double* const z2, double* const z3,
		double* const z11, double* const z12, double* const z13, double* const z21, double* const z22,
		double* const z23, double* const z31, double* const z32, double* const z33, double* const zmol,
		double* const zmos
		)
	{
		/* -------------------------- constants ------------------------- */
	...
	*    vallado, crawford, hujsak, kelso  2006
	...
	static void dsinit
		...
		// gravconsttype whichconst, 
		const double xke,
		const double cosim, double emsq, const double argpo, const double s1, const double s2,
		const double s3, const double s4, const double s5, const double sinim, const double ss1,
		const double ss2, const double ss3, const double ss4, const double ss5, const double sz1,
		const double sz3, const double sz11, const double sz13, const double sz21, const double sz23,
		const double sz31, const double sz33, const double t, const double tc, const double gsto,
		const double mo, const double mdot, const double no, const double nodeo, const double nodedot,
		const double xpidot, const double z1, const double z3, const double z11, const double z13,
		const double z21, const double z23, const double z31, const double z33, const double ecco,
		const double eccsq, double* const em, double* const argpm, double* const inclm, double* const mm,
		double* const nm, double* const nodem,
		int* const irez,
		double* const atime, double* const d2201, double* const d2211, double* const d3210, double* const d3222,
		double* const d4410, double* const d4422, double* const d5220, double* const d5232, double* const d5421,
		double* const d5433, double* const dedt, double* const didt, double* const dmdt, double* const dndt,
		double* const dnodt, double* const domdt, double* const del1, double* const del2, double* const del3,
		double* const xfact, double* const xlamo, double* const xli, double* const xni
		)
	{
		/* --------------------- local variables ------------------------ */
		const double twopi = 2.0 * pi;
	...
	*    vallado, crawford, hujsak, kelso  2006
	...
	static void dspace
		(
		const int irez,
		const double d2201, const double d2211, const double d3210, const double d3222, const double d4410,
		const double d4422, const double d5220, const double d5232, const double d5421, const double d5433,
		const double dedt, const double del1, const double del2, const double del3, const double didt,
		const double dmdt, const double dnodt, const double domdt, const double argpo, const double argpdot,
		const double t, const double tc, const double gsto, const double xfact, const double xlamo,
		const double no,
		double* const atime, double* const em, double* const argpm, double* const inclm, double* const xli,
		double* const mm, double* const xni, double* const nodem, double* const dndt, double* const nm
		)
	{
		const double twopi = 2.0 * pi;
	...
	*    vallado, crawford, hujsak, kelso  2006
	...
	static void initl
		...
		// gravconsttype whichconst, 
		const double xke, const double j2,
		const double ecco, const double epoch, const double inclo, const double no_kozai, const char opsmode __attribute__((unused)),
		char* const method, double* const ainv, double* const ao, double* const con41, double* const con42, double* const cosio,
		double* const cosio2, double* const eccsq, double* const omeosq, double* const posq,
		double* const rp, double* const rteosq, double* const sinio, double* const gsto, double* const no_unkozai
		)
	{
		/* --------------------- local variables ------------------------ */
	...
	*    vallado, crawford, hujsak, kelso  2006
	...
	bool sgp4init
		(
		const gravconsttype whichconst, const char opsmode, const char satn[5], const double epoch,
	...
	*    vallado, crawford, hujsak, kelso  2006
	...
	bool sgp4
		(
		elsetrec* const satrec, const double tsince,
	...
	*    vallado, crawford, hujsak, kelso  2006
	...
	void getgravconst
		(
		const gravconsttype whichconst,
		double* const tumin,
		double* const mus,
		double* const radiusearthkm,
		double* const xke,
		double* const j2,
		double* const j3,
		double* const j4,
	...
	*    vallado, crawford, hujsak, kelso  2006
		...
		)
	{
		...
		if (longstr1[68] == ' ')
			longstr1[68] = '0';
                char(*placeholder)[6] = &satrec->satnum;
                sscanf(longstr1,
                       "%2d %5s %1c %10s %2d %12lf %11lf %7lf %2d %7lf %2d %2d "
                       "%6ld ",
                       &cardnumb, placeholder, &satrec->classification,
                       &satrec->intldesg, &satrec->epochyr, &satrec->epochdays,
                       &satrec->ndot, &satrec->nddot, &nexp, &satrec->bstar,
	...
	* --------------------------------------------------------------------------- */
	...
	void newtonnu_SGP4
		(
		const double ecc, const double nu,
		double* const e0, double* const m
		)
	{
	...
	* --------------------------------------------------------------------------- */
	...
	void rv2coe_SGP4
		(
		const double r[3], const double v[3], const double mus,
		double* const p, double* const a, double* const ecc, double* const incl, double* const omega, double* const argp,
		double* const nu, double* const m, double* const arglat, double* const truelon, double* const lonper
		)
	{
	...
	* --------------------------------------------------------------------------- */
	...
	void    jday_SGP4
		(
		const int year, const int mon, const int day, const int hr, const int minute, const double sec,
		double* const jd, double* const jdFrac
		)
	{
		*jd = 367.0 * year -
	...
	* --------------------------------------------------------------------------- */
	...
	void    days2mdhms_SGP4
		(
		const int year, const double days,
		int* const mon, int* const day, int* const hr, int* const minute, double* const sec
		)
	{
	...
	* --------------------------------------------------------------------------- */
	...
	void    invjday_SGP4
		...
		int* const year, int* const mon, int* const day,
		int* const hr, int* const minute, double* const sec
		)
	{
		int leapyrs;
